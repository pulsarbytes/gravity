...
build/main.o: src/main.c include/constants.h include/structs.h lib/pcg-c-basic-0.9/pcg_basic.h
	$(CC) -c $(COMPILER_FLAGS) src/main.c $(LINKER_FLAGS) -o build/main.o

build/sdl.o: src/sdl.c include/constants.h
	$(CC) -c $(COMPILER_FLAGS) src/sdl.c $(LINKER_FLAGS) -o build/sdl.o

build/physics.o: src/physics.c include/constants.h include/structs.h
	$(CC) -c $(COMPILER_FLAGS) src/physics.c $(LINKER_FLAGS) -o build/physics.o

build/math.o: src/math.c include/constants.h include/structs.h
	$(CC) -c $(COMPILER_FLAGS) src/math.c $(LINKER_FLAGS) -o build/math.o

build/events.o: src/events.c include/constants.h
	$(CC) -c $(COMPILER_FLAGS) src/events.c $(LINKER_FLAGS) -o build/events.o

build/helper.o: src/helper.c include/constants.h include/structs.h
	$(CC) -c $(COMPILER_FLAGS) src/helper.c $(LINKER_FLAGS) -o build/helper.o

build/console.o: src/console.c include/constants.h include/structs.h
